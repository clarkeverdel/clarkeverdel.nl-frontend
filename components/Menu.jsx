...
class Menu extends Component {
  ...
  componentDidMount() {
    const navlink = document.getElementsByClassName('nav-link-text');
    TweenMax.from(navlink, { duration: 0.5, opacity: 1, y: +50 }, '+=0.5');
  }
                  ...
                  <div>
                    ...
                    <svg version="1.1" id="cv_logo_nieuw" className="cv_logo_nieuw" x="0px" y="0px" width="167.2px" height="42.5px" viewBox="0 0 167.2 42.5">
                      ...
                      <g>
                        <path
                          className="st0"
                          d="M81.7,12.7c-0.7,1.3-2.1,2.1-3.7,2.1c-2.4,0-4.3-1.9-4.3-4.3s1.9-4.3,4.3-4.3c1.6,0,3,0.9,3.7,2.1L85,6.5
                        ...
                        <polygon
                          className="st0"
                          points="165.7,6.5 165.7,2.6 153.9,2.6 153.9,18.5 165.7,18.5 165.7,14.7 157.8,14.7 157.8,12.5 163.5,12.5
                          163.5,8.6 157.8,8.6 157.8,6.5"
                        />
                        <polygon
                          className="st0"
                          points="149.4,28 149.4,24.1 137.6,24.1 137.6,40 149.4,40 149.4,36.1 141.5,36.1 141.5,34 147.2,34
                          147.2,30.1 141.5,30.1 141.5,28"
                        />
                        <path
                          className="st0"
                          d="M129.1,18.5h4.4l-2.8-4.8c1.6-1.1,2.7-2.9,2.7-5c0-3.3-2.7-6-6-6h-5.8v15.9h3.8v-3.8h1.4L129.1,18.5z
                           M125.6,6.5h1.9c1.2,0,2.2,1,2.2,2.2s-1,2.2-2.2,2.2h-1.9V6.5z"
                        />
                        <polygon
                          className="st0"
                          points="150.6,2.6 146.2,2.6 141.6,8.7 141.6,2.6 137.8,2.6 137.8,18.5 141.6,18.5 141.6,12.4 146.2,18.5
                          150.6,18.5 145,10.6"
                        />
                        <polygon
                          className="st0"
                          points="105.9,14.6 105.9,14.6 108.7,9.8 111.6,14.6 111.5,14.6 113.8,18.5 118.2,18.5 108.7,2.1 99.2,18.5
                          103.7,18.5"
                        />
                        ...
                        <path
                          className="st0"
                          d="M126.7,24.1H121V40h3.8v0h1.9c4.4,0,7.9-3.5,7.9-7.9C134.6,27.7,131.1,24.1,126.7,24.1z M126.7,36.1h-1.9V28
                        ...
                        <g className="stroke-me">
                          ...
                          <path
                            className="st3"
                            d="M29.4,25.3c-0.5,1.2-1.2,2.3-2.1,3.2c-0.9,0.9-2,1.6-3.2,2.1c-1.2,0.5-2.5,0.8-3.9,0.8v8.7
                            c2.5,0,5-0.5,7.3-1.5c2.2-0.9,4.2-2.3,5.9-4c1.3-1.3,2.5-2.8,3.3-4.5l-5.4-9.4L29.4,25.3z"
                          />
                          <path
                            className="st4"
                            d="M20.9,31.3c-0.2,0-0.4,0-0.6,0c-1.3,0-2.6-0.3-3.9-0.8c-1.2-0.5-2.2-1.2-3.2-2.1c-0.9-0.9-1.6-2-2.1-3.2
                        ...
                        <polygon
                          className="st0"
                          points="101.3,28 101.3,24.1 89.6,24.1 89.6,40 101.3,40 101.3,36.1 93.4,36.1 93.4,34 99.2,34 99.2,30.1
                          93.4,30.1 93.4,28"
                        />
                        <path
                          className="st0"
                          d="M112.6,40h4.4l-2.8-4.8c1.6-1.1,2.7-2.9,2.7-5c0-3.3-2.7-6-6-6h-5.8V40h3.8v-3.8h1.4L112.6,40z M109.1,28h1.9
